...
test("recovers filenames from legacy iOS container paths", () => {
  assert.equal(storedImageName("file:///old-container/Documents/fashion-canvas-images/outfit-1.jpg"), "outfit-1.jpg");
});

test("recovers filenames from legacy Android app-storage paths", () => {
  assert.equal(storedImageName("file:///data/user/0/app.example/files/fashion-canvas-images/piece-1.webp"), "piece-1.webp");
});
